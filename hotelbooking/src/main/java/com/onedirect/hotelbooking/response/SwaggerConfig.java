...
public class SwaggerConfig {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.onedirect.hotelbooking.controller"))
	...
	private ApiInfo metaData() {
		return new ApiInfo("Spring Boot REST API", "Spring Boot REST API for hotel booking management", "1.0",
				"Terms of service", new Contact("veera", "https://www.payoda.com/", "veerabahu.s@payoda.com"),
